...
save_dir = "长沙市雨花区人民法院"  # 保存xlsx文件的目录
        ...
        for link in links:
            ...
            if "article/detail" in href:  # 确保是子页面链接
                ...
                for xlsx_link in xlsx_links:
                    ...
                    if xlsx_href.endswith(".xlsx") or xlsx_href.endswith(".xls") or xlsx_href.endswith("enclosure"):  # 确保是xlsx文件
...
urls = [f"{start_page}{page}.shtml" for page in range(11, 12)]
