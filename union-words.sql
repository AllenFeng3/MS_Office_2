...
select word, 'kaoyan' as 'sources' from `98-kaoyan` union
...
select word, 'others' as 'sources' from `99-others` union
select word, 'primary' as 'sources' from `99-primary` union
select word, 'sat' as 'sources' from `99-sat` union
select word, 'toefl' as 'sources' from `99-toefl` union
select word, 'highschool' as 'sources' from `highschoolwords` union
select word, 'postgraduate' as 'sources' from `postgraduatewords`;